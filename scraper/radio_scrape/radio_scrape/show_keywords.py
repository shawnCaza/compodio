...
class TagShows:
    ...
    def process_corpus_item(self, txt):
        ...
        return txt.lower().replace("r&b","rhythmAndBlues").replace("r & b","rhythmAndBlues").replace("free-jazz","freeJazz jazz").replace("hip hop","hipHop").replace("hip-hop","hipHop").replace("spoken word","spokenWord").replace("deep dive","deepDive").replace("!","").replace("-","").replace("free form","freeForm").replace("’","").replace("'","").replace("guelphs","guelph").replace("womens","women").replace("montreals","montreal").replace("montréals","montreal").replace("the environment", "environmental").replace("activists", "activism").replace("activist", "activism").replace("take action", "activism").replace("grooves", "groove")
